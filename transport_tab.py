...
class TransportTab(ttk.Frame):
    def __init__(self, master, lp_counter, zlecenia_lista, *args, **kwargs):
        ...
        ttk.Button(col2, text="Zapisz", command=self.aktualizuj_export).grid(row=1, column=2)
        ...
        ttk.Button(col3, text="Zapisz", command=self.aktualizuj_import).grid(row=1, column=2)
        ...
        ttk.Button(col4, text="Zapisz", command=self.aktualizuj_uwagi).grid(row=1, column=2)
